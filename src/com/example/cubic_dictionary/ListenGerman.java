...
public class ListenGerman extends Activity implements OnInitListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_listen_german);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.listen_german, menu);
		return true;
	}
	...
	public void onInit(int status) {
		...
		{
			int show=ttshear.setLanguage(Locale.GERMANY);
