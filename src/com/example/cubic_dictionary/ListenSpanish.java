...
public class ListenSpanish extends Activity implements OnInitListener {
Button btnhear;
EditText ethear;
TextToSpeech ttshear;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_listen_spanish);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.listen_spanish, menu);
		return true;
	}
	@Override
	public void onInit(int status) {
		...
		if(status == TextToSpeech.SUCCESS)
		{
			...
			int show=ttshear.setLanguage(Locale.ENGLISH);
